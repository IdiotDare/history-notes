...
var infoObj = {
  ...
  zhou: [
       "The Dynastic Cycle, can be considered the life cycle of a dynasty: 1. Strong dynasty establishes peace and prosperity; considered to have Mandate of Heaven.",
         ...
         "The Dynastic Cycle, can be considered the life cycle of a dynasty: 4. Because said dynasty is seen as having lost the Mandate of Heaven(God's approval), it justifies rebellions.",
         "The Dynastic Cycle, can be considered the life cycle of a dynasty: 5. Dynasty gets overthrown through revolts and bloodshed, and a new dynasty emerges.",
         "The Dynastic Cycle, can be considered the life cycle of a dynasty: 6. The new dynasty gains power; restores peace and order, claims to have Mandate of Heaven.",
    "The Zhou dynasty started the concept of the Dynastic Cycle and the Mandate of Heaven as an excuse to overthrow the Shang.",
    "Accomplishments: Introduction of the feudal system to China as they divded their lands into regions to be governed by a family member",
    "Accomplishments: construction of roads and canals -stimulates trade and farming",
    "Accomplishments: Standard system of coin -makes trade easier, no money conversion needed and varying values",
    "Blast furnaces -produces iron weapons and tools",
...
function hanChange(){
  document.getElementById('han-text').innerHTML = infoObj.han[3];
}
